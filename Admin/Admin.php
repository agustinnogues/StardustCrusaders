    ...
    if ($idUsuario == $idAdministrador) {
        ...
        try {
            ...
            if (!$usuario) {
                ...
                /*
                |--------------------------------------------------------------
                | Guardamos el nombre antes de eliminarlo
                |--------------------------------------------------------------
                */
                ...
                |--------------------------------------------------------------
                | IMPORTANTE:
                | Tu tabla ADMIN_U tiene una FK hacia USUARIO.
                | Por lo tanto, si registramos la acción y después
                | intentamos eliminar al usuario, MySQL puede impedirlo.
                |
                | Por ahora registramos la acción después de las eliminaciones.
                | Si ADMIN_U tiene registros anteriores de ese usuario,
                | será necesario ajustar la FK.
                */
                ...
                */
                ...
                /*
                Registrar acción
                Esto solamente funcionará si ID_Usu puede quedar NULL
                o si modificamos la estructura de ADMIN_U.
                */
                $accion = "Eliminó al usuario " . $nombreUsuario;
                /*
                Por ahora no insertamos el registro aquí porque la FK
                de ADMIN_U necesita que el usuario todavía exista.
                Lo solucionaremos modificando ADMIN_U.
                */
                $conexion->commit();
...
<head>
    ...
    <title>Panel de Administración - Stardust Crusaders</title>
